              ...
              <div class="nav-content rw">
                  <div class="nav-options rw">
                      ...
                      <div id="nav-left" class="nav-left rw">
                          ...
                          <div class="nav-options rw">
                              <a href="alunos.html"    title="Lista de Alunos"><span class="icon-nav users"></span></a>
                              <a href="documentos.html" title="Documentos"><span class="icon-nav file-text"></span></a>
                              <a href="modelos.html"   title="Modelos de Documento"><span class="icon-nav square-pencil"></span></a>
                              ${
                                nivel === "admin"
                                  ? `<a href="admin.html" title="Painel Administrativo"><span class="icon-nav admin-icon"></span></a>`
                                  : ""
                              }
                  ...
                  <div class="rw g16 fc">
                      ...
                      <span class="icon teacher" title="Professor"></span>
                  </div>
              </div>
          </div>`;
  }
