...
document.addEventListener("DOMContentLoaded", function () {
          ...
          <div class="nav cl">
              <div class="nav-content rw">
                  <div class="nav-options rw">
                      <span id="hamburguer" class="icon-nav hamburguer" title="Menu"></span>
                      <div id="nav-left" class="nav-left rw">
                          <img src="../../public/imagens/logo.png" alt="logo" class="nav-logo">
                          <div class="nav-options rw">
                              <a href="area_aluno.html" title="Início"><span class="icon-nav home"></span></a>
                              <a href="enviados.html"   title="Documentos Enviados"><span class="icon-nav file-text"></span></a>
                              <a href="faq.html" title="FAQ"><span class="icon-nav question"></span></a>
                              <a id="alternador"        title="Modo Noturno"><span class="icon-nav moon"></span></a>
                              ...
                              <a id="sino-notificacoes" style="position:relative;cursor:pointer;" title="Notificações de Prazo">
                                  <span class="icon-nav" style="background-image:url('../../public/icons/sino.png')"></span>
                                  <span id="sino-badge" style="
                                      display:none;position:absolute;top:2px;right:2px;
                                      background:var(--vermelho);color:#fff;border-radius:50%;
                  ...
                  <div class="rw g16 fc">
                      <a id="perfil" href="perfil.html" title="Meu Perfil">
                      ...
                      <span class="icon student" title="Aluno"></span>
                  </div>
              </div>
          </div>`;
  }
  ...
  if (foto && navFoto) navFoto.src = `${BASE}/storage/${foto}?t=${Date.now()}`;
});
